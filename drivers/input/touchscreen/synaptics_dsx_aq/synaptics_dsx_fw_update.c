...
#define AQU_BOE_FW_IMAGE_NAME "synaptics/PR2459435-BOE-4004E314_0906.img"
#define AQU_TM_FW_IMAGE_NAME "synaptics/PR2459433-TM-4001E315_0905.img"
...
#define Titan_BOE_FW_IMAGE_NAME "synaptics/Asus_Titan_424F0034.img"
...
static void fwu_parse_image_header_05_06(void)
{
	...
	if ((fwu->img.bl_version == BL_V5 && fwu->img.contains_bootloader) ||
			(fwu->img.bl_version == BL_V6 && header->options_bootloader))
		fwu->img.contains_disp_config = true;
	else
...
static int fwu_start_reflash(void)
{
	...
	if (fwu->image == NULL) {
		retval = secure_memcpy(fwu->image_name, MAX_IMAGE_NAME_LEN,
							Titan_BOE_FW_IMAGE_NAME, sizeof(Titan_BOE_FW_IMAGE_NAME),
							sizeof(Titan_BOE_FW_IMAGE_NAME));
							printk("[Touch] : Titan_BOE_FW_IMAGE_NAME is %s\n",fwu->image_name);
	/*	switch(g_asus_lcdID)
				{
					case 6 :
							retval = secure_memcpy(fwu->image_name, MAX_IMAGE_NAME_LEN,
